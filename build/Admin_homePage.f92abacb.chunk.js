"use strict";
(self["webpackChunkstrapi_lading_pages"] = self["webpackChunkstrapi_lading_pages"] || []).push([[3981],{
...
const ContentBlocks = () => {
  ...
  return /* @__PURE__ */ react.createElement(dist.Stack, { spacing: 5 }, /* @__PURE__ */ react.createElement(
    BlockLink,
    {
...
const LogoContainer = (0,styled_components_browser_esm["default"])(dist.Box)`
  position: absolute;
  top: 0;
  right: 0;
...
const HomePage = () => {
  ...
  const { guidedTourState, isGuidedTourVisible, isSkipped } = (0,helper_plugin.useGuidedTour)();
  ...
  return /* @__PURE__ */ react.createElement(dist.Layout, null, /* @__PURE__ */ react.createElement(react_intl.FormattedMessage, { id: "HomePage.helmet.title", defaultMessage: "Homepage" }, (title) => /* @__PURE__ */ react.createElement(Helmet.Helmet, { title: title[0] })), /* @__PURE__ */ react.createElement(dist.Main, null, /* @__PURE__ */ react.createElement(LogoContainer, null, /* @__PURE__ */ react.createElement("img", { alt: "", "aria-hidden": true, src: corner_ornament_namespaceObject })), /* @__PURE__ */ react.createElement(dist.Box, { padding: 10 }, /* @__PURE__ */ react.createElement(dist.Grid, null, /* @__PURE__ */ react.createElement(dist.GridItem, { col: 8, s: 12 }, /* @__PURE__ */ react.createElement(
    HomePage_HomeHeader,
    {
      onCreateCT: handleClick,
      hasCreatedContentType: hasAlreadyCreatedContentTypes
    }
  ))), /* @__PURE__ */ react.createElement(dist.Grid, { gap: 6 }, /* @__PURE__ */ react.createElement(dist.GridItem, { col: 8, s: 12 }, showGuidedTour ? /* @__PURE__ */ react.createElement(Homepage, null) : /* @__PURE__ */ react.createElement(HomePage_ContentBlocks, null)), /* @__PURE__ */ react.createElement(dist.GridItem, { col: 4, s: 12 }, /* @__PURE__ */ react.createElement(HomePage_SocialLinks, null))))));
};
